...
// create an instance of jFrame and then set it to visible 
 ...
 * @author Jason
 */
public class PokemonRunner extends javax.swing.JApplet {
...
/*public static void main (String [] args)
{
    ...
    private void pokemonConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pokemonConfirmActionPerformed
        ...
        user = PokemonRunner.pokeLibrary().get(pokemonKey);
        ...
        foe = PokemonRunner.pokeLibrary().get(pokeKeys.get(randomPokeKey));
